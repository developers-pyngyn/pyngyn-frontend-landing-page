export type BlogPost = {
  ...
  category: string;
  author: string;
  // Optional path to a real featured image (e.g. "/blog/foo.jpg").
  // If omitted, a generated on-brand SVG cover is shown instead.
  cover?: string;
  // Body is an array of paragraphs for simple rendering.
  body: string[];
};

export const posts: BlogPost[] = [
  {
    slug: "stop-chasing-status-updates",
    title: "Stop chasing status updates",
    excerpt:
      "The weekly status meeting is a symptom, not a ritual. Here's how teams replace it with status that writes itself.",
    date: "2026-05-12",
    readingTime: "4 min read",
    category: "Product",
    author: "The PYNGYN Team",
    body: [
      "Most teams treat the status meeting as a fixed cost of working together. Someone schedules thirty minutes, everyone context-switches out of real work, and the meeting mostly surfaces information that already existed somewhere: in an email, a document, a thread.",
  ...
  {
    slug: "from-a-sentence-to-a-plan",
    title: "From a sentence to a plan",
    excerpt:
    ...
    author: "The PYNGYN Team",
    body: [
      "Planning is the part of project management everyone agrees is valuable and no one enjoys doing. Breaking a goal into tasks, sequencing them, guessing at dependencies, and assigning owners is slow, and the result is stale the moment priorities shift.",
      "When you describe a goal to PYNGYN, it generates a first-draft plan: tasks, a sensible order, likely dependencies, and owners where it can infer them. The point is not that the draft is perfect; it's that editing a draft is far faster than starting from a blank board.",
      "Good plans are living documents. As work moves, PYNGYN keeps the plan honest: re-sequencing when something slips, flagging when a dependency is about to block a deadline, and surfacing the next most important task.",
      "Treat the AI as a fast junior planner whose work you review, not an oracle you obey. That mental model is where teams get the most value.",
    ],
  },
  {
    slug: "seeing-risk-before-it-bites",
    title: "Seeing risk before it bites",
    excerpt:
    ...
    author: "The PYNGYN Team",
    body: [
      "Every missed deadline has a story, and the story almost always includes a signal that showed up early and went unnoticed: a dependency that was quietly behind, a person who was overloaded, a task that hadn't moved in a week.",
      "PYNGYN watches those signals (workload, deadlines, and the shape of dependencies) and raises a flag while there is still time to act. Not a wall of alerts, but the one or two things that actually threaten the date.",
      "The goal isn't to predict the future perfectly. It's to shorten the distance between when a risk becomes visible and when a human notices it. That distance is where most slipped deadlines live.",
    ],
  },
  {
    slug: "ai-as-a-coordination-layer",
    title: "AI works best as a coordination layer",
    excerpt:
      "AI works best when it connects people, context, and decisions without pretending to replace judgment.",
    date: "2026-04-08",
  ...
  {
    slug: "how-to-write-project-goals-ai-can-actually-plan",
    title: "How to write project goals AI can actually plan",
    excerpt:
    ...
    author: "The PYNGYN Team",
    body: [
      "A vague goal produces a vague plan, even with excellent AI. If the request is simply 'onboard the new client,' the system can infer common steps, but it cannot know which client outcome matters, what must happen first, or which constraints are non-negotiable.",
      ...
      "That level of detail gives PYNGYN enough structure to draft useful workstreams: scope and conflicts check, document collection, review, internal quality checks, client communication, and sign-off readiness. The plan is still editable, but it starts closer to the truth.",
  ...
  {
    slug: "what-changes-when-task-lists-update-themselves",
    title: "What changes when task lists update themselves",
    excerpt:
  ...
  {
    slug: "turning-scattered-decisions-into-project-memory",
    title: "Turning scattered decisions into a project memory",
    excerpt:
    ...
    body: [
      ...
      "When decisions are scattered across meeting notes, chat messages, email threads, and people's memories, new teammates have to rediscover context through interruption. Worse, teams can accidentally reopen settled debates because the original reasoning is hard to find.",
  ...
  {
    slug: "why-ownership-gets-blurry-and-how-ai-clarifies-it",
    title: "Why ownership gets blurry and how AI clarifies it",
    excerpt:
  ...
  {
    slug: "dependency-maps-are-only-useful-when-they-stay-alive",
    title: "Dependency maps are only useful when they stay alive",
    excerpt:
    ...
    body: [
      ...
      "A living dependency map does two jobs. It explains sequence, and it explains consequence. If client sign-off slips, what downstream tasks are affected? If a third party is delayed, what client promise becomes risky?",
  ...
  {
    slug: "replacing-kickoff-decks-with-living-plans",
    title: "Replacing kickoff decks with living plans",
    excerpt:
  ...
  {
    slug: "the-quiet-cost-of-stale-project-boards",
    title: "The quiet cost of stale project boards",
    excerpt:
  ...
  {
    slug: "how-ai-helps-managers-coach-instead-of-chase",
    title: "How AI helps managers coach instead of chase",
    excerpt:
    ...
    body: [
      ...
      "That frees managers to coach. Instead of asking an associate whether the handoff happened, they can ask what feedback is missing. Instead of chasing a specialist for status, they can help negotiate scope or unblock a dependency.",
  ...
  {
    slug: "a-healthier-handoff-between-team-and-client",
    title: "Building a healthier handoff between team and client",
    excerpt:
  ...
  {
    slug: "engagement-planning-works-better-with-fresh-context",
    title: "Engagement planning works better with fresh context",
    excerpt:
      "The quality of engagement planning depends on whether the team starts with yesterday's truth or last week's assumptions.",
    date: "2026-03-29",
    readingTime: "5 min read",
    category: "Planning",
    author: "The PYNGYN Team",
    body: [
      "Engagement planning is often blamed for being slow, but the meeting is usually paying a context tax. The team has to reconstruct what finished, what slipped, what changed, and which client priorities still matter before it can plan the next stretch of work.",
      ...
      "PYNGYN prepares that context by summarizing recent movement, stale tasks, blocked work, and priority changes. It can also suggest candidate work items based on readiness and dependency order.",
      "AI should not select the plan alone. Capacity, team energy, client commitments, and professional judgment still belong in the room. But the discussion starts from a cleaner baseline.",
      "Better planning is not about adding more ceremony. It is about reducing the manual reconstruction required before the real planning can begin.",
    ],
  },
  {
    slug: "what-an-ai-assistant-should-never-decide-alone",
    title: "What an AI assistant should never decide alone",
    excerpt:
  ...
  {
    slug: "detecting-scope-creep-before-it-becomes-the-plan",
    title: "Detecting scope creep before it becomes the plan",
    excerpt:
  ...
  {
    slug: "from-meeting-notes-to-measurable-next-steps",
    title: "From meeting notes to measurable next steps",
    excerpt:
  ...
  {
    slug: "why-async-updates-fail-and-how-to-repair-them",
    title: "Why async updates fail and how to repair them",
    excerpt:
  ...
  {
    slug: "the-managers-guide-to-automated-project-summaries",
    title: "The manager's guide to automated project summaries",
    excerpt:
    ...
    author: "The PYNGYN Team",
    body: [
      "A useful project summary is not a transcript of activity. Managers do not need every email, comment, and task edit. They need the pattern: what changed, what matters, and where attention is required.",
  ...
  {
    slug: "keeping-remote-teams-aligned-without-extra-rituals",
    title: "Keeping remote teams aligned without extra rituals",
    excerpt:
    ...
    author: "The PYNGYN Team",
    body: [
      "Remote teams often respond to misalignment by adding rituals: more check-ins, more recaps, more status documents, more meetings. Some rituals help, but too many create a second layer of work about the work.",
  ...
  {
    slug: "a-practical-model-for-ai-assisted-prioritization",
    title: "A practical model for AI-assisted prioritization",
    excerpt:
  ...
  {
    slug: "how-to-make-deadlines-more-honest",
    title: "How to make deadlines more honest",
    excerpt:
  ...
  {
    slug: "the-difference-between-progress-and-motion",
    title: "The difference between progress and motion",
    excerpt:
  ...
  {
    slug: "using-project-history-to-make-better-estimates",
    title: "Using project history to make better estimates",
    excerpt:
  ...
  {
    slug: "the-operating-rhythm-for-small-fast-teams",
    title: "The operating rhythm for small fast teams",
    excerpt:
    ...
    author: "The PYNGYN Team",
    body: [
      "Small teams do not need heavy process, but they do need rhythm. Without one, speed turns into scattered effort: priorities change verbally, decisions vanish into chats, and founders or managers become the routing layer for every question.",
      "A healthy rhythm has a few simple beats: define the goal, keep the plan current, review risks regularly, summarize movement, and make decisions visible. The system can be lightweight as long as it is reliable.",
      "PYNGYN helps small teams keep that rhythm without adding a full project management department. It can draft plans, generate updates, flag blockers, and preserve decisions while the team continues building.",
      "The danger for small teams is waiting until coordination pain becomes obvious. By then, habits are harder to change and too much context lives in people's heads.",
      "The best operating rhythm feels like less process, not more. It gives the team enough structure to move together while preserving the speed that made the team effective.",
    ],
  },
  {
    slug: "how-ai-can-reduce-project-management-busywork",
    title: "How AI can reduce project management busywork",
    excerpt:
    ...
    author: "The PYNGYN Team",
    body: [
      "Project management busywork is usually translation work. A conversation becomes tasks. Tasks become a summary. A summary becomes a slide. A blocker mentioned in chat becomes a follow-up reminder.",
      "Each translation is small, but together they consume attention and introduce delay. The person doing the translation becomes a bottleneck, and the project waits for information that already exists somewhere else.",
      "AI is well suited to this layer. PYNGYN can draft tasks from goals, summaries from activity, risks from signals, and follow-ups from meetings. Humans review the outputs, but they no longer start from blank pages.",
      "The best busywork to automate is repetitive, structured, and easy to verify. The worst work to automate is strategic judgment disguised as administration.",
      "Reducing busywork should make project management more human, not less. The time saved should go toward better decisions, clearer conversations, and more support for the people doing the work.",
    ],
  },
  {
    slug: "what-to-review-before-trusting-an-ai-generated-plan",
    title: "What to review before trusting an AI-generated plan",
    excerpt:
  ...
  {
    slug: "making-blockers-visible-without-blame",
    title: "Making blockers visible without blame",
    excerpt:
  ...
  {
    slug: "the-benefits-of-a-single-project-source-of-truth",
    title: "The benefits of a single project source of truth",
    excerpt:
    ...
    author: "The PYNGYN Team",
    body: [
      "Every team says it wants a single source of truth. The hard part is making that source useful enough that people choose it over side channels, private notes, and memory.",
      "A real source of truth answers practical questions quickly. What are we trying to accomplish? What is the current plan? Who owns the next step? What changed recently? What decisions explain the current direction?",
      "PYNGYN strengthens the source of truth by keeping it current. It can summarize movement, attach decisions to tasks, highlight risks, and reveal stale areas where the written plan needs human confirmation.",
      "The source does not have to contain everything. In fact, it should not. It should contain the information needed to coordinate action and understand the state of the project.",
      "The benefit is trust. When teammates trust the source, they interrupt each other less, make decisions faster, and spend less time reconciling competing versions of reality.",
    ],
  },
  {
    slug: "designing-alerts-that-teams-do-not-ignore",
    title: "Designing alerts that teams do not ignore",
    excerpt:
  ...
  {
    slug: "how-leaders-can-read-project-health-in-five-minutes",
    title: "How leaders can read project health in five minutes",
    excerpt:
  ...
  {
    slug: "the-role-of-ai-in-multi-team-client-engagements",
    title: "The role of AI in multi-team client engagements",
    excerpt:
      "Big client engagements need shared context across partners, associates, specialists, and the client.",
    date: "2026-03-11",
    readingTime: "6 min read",
    category: "Engagements",
    author: "The PYNGYN Team",
    body: [
      "Multi-team engagements fail in the gaps between roles. The partner knows the scope, associates know the delivery risk, specialists know the technical detail, and the client knows what they need first.",
      "The engagement plan has to connect those perspectives. A deliverable is not ready just because the work is done. Review, documentation, client communication, and sign-off all shape the outcome.",
      "PYNGYN can draft engagement workstreams, connect dependencies, and summarize readiness across teams. If a client review depends on final sign-off, or a deliverable depends on partner approval, that relationship should be visible.",
      "AI is especially helpful at maintaining the plan as reality changes. When scope shifts, the downstream tasks should update too, instead of being discovered in the final week.",
      "The human work remains alignment. Partners still choose tradeoffs, owners still commit to deliverables, and people still bring expertise. AI keeps coordination from becoming the bottleneck.",
    ],
  },
  {
    slug: "bringing-project-management-back-to-the-work",
    title: "Bringing project management back to the work",
    excerpt:
